...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.ReturnStatus();
  });
  ...
  describe('ReturnStatus', function() {
    it('should create an instance of ReturnStatus', function() {
      // uncomment below and update the code to test ReturnStatus
      //var instance = new Crossborder.ReturnStatus();
      //expect(instance).to.be.a(Crossborder.ReturnStatus);
    });
