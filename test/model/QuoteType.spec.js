...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.QuoteType();
  });
  ...
  describe('QuoteType', function() {
    it('should create an instance of QuoteType', function() {
      // uncomment below and update the code to test QuoteType
      //var instance = new Crossborder.QuoteType();
      //expect(instance).to.be.a(Crossborder.QuoteType);
    });
