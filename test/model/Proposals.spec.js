...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.Proposals();
  });
  ...
  describe('Proposals', function() {
    it('should create an instance of Proposals', function() {
      // uncomment below and update the code to test Proposals
      //var instance = new Crossborder.Proposals();
      //expect(instance).to.be.a(Crossborder.Proposals);
    });
