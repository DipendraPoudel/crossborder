...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.RetrievePaymentWrapper();
  });
  ...
  describe('RetrievePaymentWrapper', function() {
    it('should create an instance of RetrievePaymentWrapper', function() {
      // uncomment below and update the code to test RetrievePaymentWrapper
      //var instance = new Crossborder.RetrievePaymentWrapper();
      //expect(instance).to.be.a(Crossborder.RetrievePaymentWrapper);
    });
