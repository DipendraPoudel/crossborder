...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.CancelPaymentRequest();
  });
  ...
  describe('CancelPaymentRequest', function() {
    it('should create an instance of CancelPaymentRequest', function() {
      ...
      //var instance = new Crossborder.CancelPaymentRequest();
      //expect(instance).to.be.a(Crossborder.CancelPaymentRequest);
    });
