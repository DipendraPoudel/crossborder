...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.AdditionalDataList();
  });
  ...
  describe('AdditionalDataList', function() {
    it('should create an instance of AdditionalDataList', function() {
      // uncomment below and update the code to test AdditionalDataList
      //var instance = new Crossborder.AdditionalDataList();
      //expect(instance).to.be.a(Crossborder.AdditionalDataList);
    });
