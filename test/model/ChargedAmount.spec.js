...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.ChargedAmount();
  });
  ...
  describe('ChargedAmount', function() {
    it('should create an instance of ChargedAmount', function() {
      // uncomment below and update the code to test ChargedAmount
      //var instance = new Crossborder.ChargedAmount();
      //expect(instance).to.be.a(Crossborder.ChargedAmount);
    });
