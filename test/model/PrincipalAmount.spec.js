...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.PrincipalAmount();
  });
  ...
  describe('PrincipalAmount', function() {
    it('should create an instance of PrincipalAmount', function() {
      // uncomment below and update the code to test PrincipalAmount
      //var instance = new Crossborder.PrincipalAmount();
      //expect(instance).to.be.a(Crossborder.PrincipalAmount);
    });
