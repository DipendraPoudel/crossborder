...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.FxType();
  });
  ...
  describe('FxType', function() {
    it('should create an instance of FxType', function() {
      // uncomment below and update the code to test FxType
      //var instance = new Crossborder.FxType();
      //expect(instance).to.be.a(Crossborder.FxType);
    });
