...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.SettlementAccountBalance();
  });
  ...
  describe('SettlementAccountBalance', function() {
    it('should create an instance of SettlementAccountBalance', function() {
      // uncomment below and update the code to test SettlementAccountBalance
      //var instance = new Crossborder.SettlementAccountBalance();
      //expect(instance).to.be.a(Crossborder.SettlementAccountBalance);
    });
