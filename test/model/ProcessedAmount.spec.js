...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.ProcessedAmount();
  });
  ...
  describe('ProcessedAmount', function() {
    it('should create an instance of ProcessedAmount', function() {
      // uncomment below and update the code to test ProcessedAmount
      //var instance = new Crossborder.ProcessedAmount();
      //expect(instance).to.be.a(Crossborder.ProcessedAmount);
    });
