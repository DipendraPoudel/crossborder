...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.CancelPaymentWrapper();
  });
  ...
  describe('CancelPaymentWrapper', function() {
    it('should create an instance of CancelPaymentWrapper', function() {
      // uncomment below and update the code to test CancelPaymentWrapper
      //var instance = new Crossborder.CancelPaymentWrapper();
      //expect(instance).to.be.a(Crossborder.CancelPaymentWrapper);
    });

    it('should have the property cancelpayment (base name: "cancelpayment")', function() {
      // uncomment below and update the code to test the property cancelpayment
      //var instance = new Crossborder.CancelPaymentWrapper();
