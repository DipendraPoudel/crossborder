...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.Reverse();
  });
  ...
  describe('Reverse', function() {
    it('should create an instance of Reverse', function() {
      // uncomment below and update the code to test Reverse
      //var instance = new Crossborder.Reverse();
      //expect(instance).to.be.a(Crossborder.Reverse);
    });

    it('should have the property senderCurrency (base name: "sender_currency")', function() {
      // uncomment below and update the code to test the property senderCurrency
      //var instance = new Crossborder.Reverse();
