...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.Forward();
  });
  ...
  describe('Forward', function() {
    it('should create an instance of Forward', function() {
      // uncomment below and update the code to test Forward
      //var instance = new Crossborder.Forward();
      //expect(instance).to.be.a(Crossborder.Forward);
    });
    ...
    it('should have the property receiverCurrency (base name: "receiver_currency")', function() {
      // uncomment below and update the code to test the property receiverCurrency
      //var instance = new Crossborder.Forward();
      //expect(instance).to.be();
    });
