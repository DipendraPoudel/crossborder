...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.QuoteRequestWrapper();
  });
  ...
  describe('QuoteRequestWrapper', function() {
    it('should create an instance of QuoteRequestWrapper', function() {
      // uncomment below and update the code to test QuoteRequestWrapper
      //var instance = new Crossborder.QuoteRequestWrapper();
      //expect(instance).to.be.a(Crossborder.QuoteRequestWrapper);
    });

    it('should have the property quoterequest (base name: "quoterequest")', function() {
      // uncomment below and update the code to test the property quoterequest
      //var instance = new Crossborder.QuoteRequestWrapper();
