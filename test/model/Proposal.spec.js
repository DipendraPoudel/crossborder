...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.Proposal();
  });
  ...
  describe('Proposal', function() {
    it('should create an instance of Proposal', function() {
      ...
      //var instance = new Crossborder.Proposal();
      //expect(instance).to.be.a(Crossborder.Proposal);
    });
    ...
    it('should have the property feesIncluded (base name: "fees_included")', function() {
      // uncomment below and update the code to test the property feesIncluded
      //var instance = new Crossborder.Proposal();
      //expect(instance).to.be();
    });
    ...
    it('should have the property quoteFxRate (base name: "quote_fx_rate")', function() {
      // uncomment below and update the code to test the property quoteFxRate
      //var instance = new Crossborder.Proposal();
      //expect(instance).to.be();
    });
    ...
    it('should have the property confirmationExpiryTime (base name: "confirmation_expiry_time")', function() {
      // uncomment below and update the code to test the property confirmationExpiryTime
      //var instance = new Crossborder.Proposal();
      //expect(instance).to.be();
    });
