...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.ThresholdAmount();
  });
  ...
  describe('ThresholdAmount', function() {
    it('should create an instance of ThresholdAmount', function() {
      // uncomment below and update the code to test ThresholdAmount
      //var instance = new Crossborder.ThresholdAmount();
      //expect(instance).to.be.a(Crossborder.ThresholdAmount);
    });
