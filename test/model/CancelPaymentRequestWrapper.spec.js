...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.CancelPaymentRequestWrapper();
  });
  ...
  describe('CancelPaymentRequestWrapper', function() {
    it('should create an instance of CancelPaymentRequestWrapper', function() {
      // uncomment below and update the code to test CancelPaymentRequestWrapper
      //var instance = new Crossborder.CancelPaymentRequestWrapper();
      //expect(instance).to.be.a(Crossborder.CancelPaymentRequestWrapper);
    });

    it('should have the property cancelpaymentrequest (base name: "cancelpaymentrequest")', function() {
      // uncomment below and update the code to test the property cancelpaymentrequest
      //var instance = new Crossborder.CancelPaymentRequestWrapper();
