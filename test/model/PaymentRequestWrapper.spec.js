...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.PaymentRequestWrapper();
  });
  ...
  describe('PaymentRequestWrapper', function() {
    it('should create an instance of PaymentRequestWrapper', function() {
      // uncomment below and update the code to test PaymentRequestWrapper
      //var instance = new Crossborder.PaymentRequestWrapper();
      //expect(instance).to.be.a(Crossborder.PaymentRequestWrapper);
    });
