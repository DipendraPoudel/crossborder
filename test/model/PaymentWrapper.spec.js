...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.PaymentWrapper();
  });
  ...
  describe('PaymentWrapper', function() {
    it('should create an instance of PaymentWrapper', function() {
      // uncomment below and update the code to test PaymentWrapper
      //var instance = new Crossborder.PaymentWrapper();
      //expect(instance).to.be.a(Crossborder.PaymentWrapper);
    });
