...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.RetrievePayment();
  });
  ...
  describe('RetrievePayment', function() {
    it('should create an instance of RetrievePayment', function() {
      // uncomment below and update the code to test RetrievePayment
      //var instance = new Crossborder.RetrievePayment();
      //expect(instance).to.be.a(Crossborder.RetrievePayment);
    });
    ...
    it('should have the property rejectedStatus (base name: "rejected_status")', function() {
      // uncomment below and update the code to test the property rejectedStatus
      //var instance = new Crossborder.RetrievePayment();
      //expect(instance).to.be();
    });

    it('should have the property returnStatus (base name: "return_status")', function() {
      // uncomment below and update the code to test the property returnStatus
      //var instance = new Crossborder.RetrievePayment();
      //expect(instance).to.be();
    });
