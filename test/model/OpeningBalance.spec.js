...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.OpeningBalance();
  });
  ...
  describe('OpeningBalance', function() {
    it('should create an instance of OpeningBalance', function() {
      // uncomment below and update the code to test OpeningBalance
      //var instance = new Crossborder.OpeningBalance();
      //expect(instance).to.be.a(Crossborder.OpeningBalance);
    });
