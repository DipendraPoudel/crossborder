...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.CreditedAmount();
  });
  ...
  describe('CreditedAmount', function() {
    it('should create an instance of CreditedAmount', function() {
      // uncomment below and update the code to test CreditedAmount
      //var instance = new Crossborder.CreditedAmount();
      //expect(instance).to.be.a(Crossborder.CreditedAmount);
    });
