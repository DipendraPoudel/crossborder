...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instance = new Crossborder.Account();
      //expect(instance).to.be.a(Crossborder.Account);
    });
    ...
    it('should have the property openingBalanceTimestamp (base name: "openingBalanceTimestamp")', function() {
      // uncomment below and update the code to test the property openingBalanceTimestamp
      //var instance = new Crossborder.Account();
      //expect(instance).to.be();
    });

    it('should have the property balanceAsOfTimestamp (base name: "balanceAsOfTimestamp")', function() {
      // uncomment below and update the code to test the property balanceAsOfTimestamp
      //var instance = new Crossborder.Account();
      //expect(instance).to.be();
    });
