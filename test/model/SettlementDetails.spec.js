...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.SettlementDetails();
  });
  ...
  describe('SettlementDetails', function() {
    it('should create an instance of SettlementDetails', function() {
      // uncomment below and update the code to test SettlementDetails
      //var instance = new Crossborder.SettlementDetails();
      //expect(instance).to.be.a(Crossborder.SettlementDetails);
    });
