...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.ReservedBalance();
  });
  ...
  describe('ReservedBalance', function() {
    it('should create an instance of ReservedBalance', function() {
      // uncomment below and update the code to test ReservedBalance
      //var instance = new Crossborder.ReservedBalance();
      //expect(instance).to.be.a(Crossborder.ReservedBalance);
    });
