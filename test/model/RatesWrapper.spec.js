...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.RatesWrapper();
  });
  ...
  describe('RatesWrapper', function() {
    it('should create an instance of RatesWrapper', function() {
      // uncomment below and update the code to test RatesWrapper
      //var instance = new Crossborder.RatesWrapper();
      //expect(instance).to.be.a(Crossborder.RatesWrapper);
    });
