...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.Tiers();
  });
  ...
  describe('Tiers', function() {
    it('should create an instance of Tiers', function() {
      // uncomment below and update the code to test Tiers
      //var instance = new Crossborder.Tiers();
      //expect(instance).to.be.a(Crossborder.Tiers);
    });
