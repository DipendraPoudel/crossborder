...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.GovernmentIds();
  });
  ...
  describe('GovernmentIds', function() {
    it('should create an instance of GovernmentIds', function() {
      // uncomment below and update the code to test GovernmentIds
      //var instance = new Crossborder.GovernmentIds();
      //expect(instance).to.be.a(Crossborder.GovernmentIds);
    });
