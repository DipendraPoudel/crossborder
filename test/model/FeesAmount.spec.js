...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.FeesAmount();
  });
  ...
  describe('FeesAmount', function() {
    it('should create an instance of FeesAmount', function() {
      // uncomment below and update the code to test FeesAmount
      //var instance = new Crossborder.FeesAmount();
      //expect(instance).to.be.a(Crossborder.FeesAmount);
    });
