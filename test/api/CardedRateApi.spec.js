...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.CardedRateApi();
  });
  ...
  describe('CardedRateApi', function() {
    describe('getFxRates', function() {
      it('should call getFxRates successfully', function(done) {
        //uncomment below and update the code to test getFxRates
        //instance.getFxRates(function(error) {
