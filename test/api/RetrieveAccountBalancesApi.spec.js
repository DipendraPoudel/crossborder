...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Crossborder.RetrieveAccountBalancesApi();
  });
  ...
  describe('RetrieveAccountBalancesApi', function() {
    describe('getAllAccountBalances', function() {
      it('should call getAllAccountBalances successfully', function(done) {
        //uncomment below and update the code to test getAllAccountBalances
        //instance.getAllAccountBalances(function(error) {
