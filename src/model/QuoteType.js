...
/**
 * The QuoteType model module.
 * @module model/QuoteType
 * @version 1.0.0
 */
class QuoteType {
    /**
     * Constructs a new <code>QuoteType</code>.
     * Either a forward quote type or a reverse quote type should be submitted, but not both. All quote type parameters are optional (forward fees included &#x3D; true when quote type not provided). Forward quote type should not be used with the Customer Managed Sender Pricing model.
     * @alias module:model/QuoteType
     */
    constructor() { 
        
        QuoteType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>QuoteType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/QuoteType} obj Optional instance to populate.
     * @return {module:model/QuoteType} The populated <code>QuoteType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new QuoteType();
    ...
    /**
     * Validates the JSON data with respect to <code>QuoteType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QuoteType</code>.
     */
 ...
 */
QuoteType.prototype['forward'] = undefined;

/**
 * @member {module:model/Reverse} reverse
 */
QuoteType.prototype['reverse'] = undefined;
