...
/**
 * This parameter contains an identifier for an additional field. It is required if the data.data_field.value is populated.   It is a conditional parameter that holds a string of numeric values with a maximum length of five and a minimum length of one.
 * @member {String} name
 */
DataField.prototype['name'] = undefined;

/**
 * This parameter contains detailed information for an additional field. This parameter is required if the data.data_field.name is populated. It is a conditional parameter that holds a string of alphanumeric special characters with a maximum length of 1000 and a minimum length of 1.
 * @member {String} value
 */
